...
- [Тесты сервисов](services/README.md)
- [Тесты плагинов](plugins/README.md)
- [Тесты роутинга](router/README.md)
...
- `router/` — тесты роутинга и гардов.
...
- Вывод тестов настроен на подробный режим (`verbose`), чтобы видеть имена отдельных тестов.
